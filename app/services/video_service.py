from app.utils.ffmpeg_utils import get_video_quality, apply_aspect_ratio, reduce_video_quality
from app.utils.file_operations import remove_temp_files, TEMP_DIR, FINAL_OUTPUT_DIR
from app.utils.enums import VideoQuality  # Import the VideoQuality enum
...
async def handle_video_upload(video: UploadFile, aspect_ratio: str, quality: VideoQuality) -> dict:
    ...
    try:
        ...
        remove_temp_files(final_output_path)
